...
class Node:
    ...
    def calculate_blocking_steps(self):
        """
        This method calculates and returns the blocking steps from the coordinates of the cars till the goal board configuration.
        """
...
class AStar:
    ...
    def __init__(self, board):
        """
        This method initializes an A* algorithm with an open list, a closed list and a start board which is passed.
        """
        self.open = []
    ...
    def return_found_path(self, node):
        """
        This method will return the path of the node that is given by tracing back each parent until there is no more node.
        """
        path = []
        current_node = node
